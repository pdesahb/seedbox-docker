...
# Test des variables
for myvar in SERVER_BASE_URL TRAEFIK_BASE_URL PASSWD_FILE ADMIN_EMAIL\
 CONFIG_DIR DATA_DIR PORTAINER_BASE_URL RUTORRENT_BASE_URL MEDUSA_BASE_URL \
 ...
 NEXTCLOUD_BASE_URL SABNZBD_BASE_URL PYLOAD_BASE_URL FLARESOLVERR_BASE_URL READARR_BASE_URL JELLYFIN_BASE_URL TZ LVM_STATUS 
do
    if [ -z "${!myvar}" ]; then
